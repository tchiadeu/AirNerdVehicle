...
vehicle9 = Vehicle.create(user_id: User.last.id, name: 'Santa Sleigh', price: 1, city: 'Khartoum', category: 'Fantasy')
vehicle10 = Vehicle.create(user_id: User.last.id, name: 'Chat-Bus', price: 150, city: 'Khartoum', category: 'Fantasy')
Vehicle.create(user_id: User.first.id, name: 'Millenium Falcon', price: 10_000, city: 'Kiev', category: 'SF', available: true, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbLFKaIBd1Hs6MZGm8_Y4YE7MyTOFrWlBZrQ&usqp=CAU')
...
Vehicle.create(user_id: User.first.id, name: 'the Flying Dutchman', price: 2000, city: 'Saint-Domingue', category: 'Fantasy', available: true, image: 'https://i.pinimg.com/736x/23/4c/9f/234c9f872637c7d20d75a1294df2fa2c.jpg')
...
Vehicle.create(user_id: User.last.id, name: 'Toyota Fast & Furious', price: 250, city: 'Los Angeles', category: 'Classical', available: true, image: 'https://i.pinimg.com/originals/68/1b/54/681b5411369353221a1109fbaff9237b.jpg')
Vehicle.create(user_id: User.last.id, name: 'Taxi with Sami as driver', price: 350, city: 'Marseille', category: 'Classical', available: true, image: 'https://i.ytimg.com/vi/mL5DnlpNZC0/maxresdefault.jpg')
Vehicle.create(user_id: User.last.id, name: 'The Magic Bus', price: 10, city: 'Moscou', category: 'Classical', available: true, image: 'https://static.hitek.fr/img/actualite/2017/02/09/fb_unnamed-18.webp')
Vehicle.create(user_id: User.last.id, name: 'Alladins Flying Carpet', price: 500, city: 'Khartoum', category: 'Classical', available: true, image: 'https://disney-planet.fr/wp-content/uploads/2016/11/tapis-magique-personnage-aladdin-06.jpg')
Vehicle.create(user_id: User.last.id, name: 'Santa Sleigh', price: 1, city: 'Upernavik', category: 'superheroes', available: true, image: 'http://www.etrepagny.fr/wp-content/uploads/2018/12/fabrication-traineau-pere-norel-etrepagny-2018-13.jpg')
Vehicle.create(user_id: User.last.id, name: 'Chat-Bus', price: 150, city: 'Tokyo', category: 'fantasy', available: true, image: 'https://kultt.fr/wp-content/uploads/2018/06/chatbus-velo-Hiroshima-uai-640x360.jpg')
