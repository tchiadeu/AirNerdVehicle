...
vehicle1 = Vehicle.create(user_id: User.last.id, name: 'Millenium Falcon', price: 10_000, city: 'Kiev', category: 'SF')
vehicle3 = Vehicle.create(user_id: User.last.id, name: 'the Flying Dutchman', price: 2000, city: 'Saint-Domingue', category: 'Fantasy')
...
date2 = Date.new(2023, 5, 10)
date3 = Date.new(2023, 5, 11)
date4 = Date.new(2023, 5, 17)
date5 = Date.new(2023, 5, 20)
date6 = Date.new(2023, 5, 21)
date7 = Date.new(2023, 4, 4)
date8 = Date.new(2023, 4, 5)
date9 = Date.new(2023, 3, 7)
date10 = Date.new(2023, 3, 9)
date11 = Date.new(2023, 4, 14)
date12 = Date.new(2023, 4, 16)

Booking.create(start: date1, end: date2, user_id: User.last.id, vehicle_id: Vehicle.first.id, status: 'Pending')
Booking.create(start: date3, end: date4, user_id: User.last.id, vehicle_id: Vehicle.first.id, status: 'Pending')
Booking.create(start: date5, end: date6, user_id: User.last.id, vehicle_id: Vehicle.first.id, status: 'Pending')
Booking.create(start: date7, end: date8, user_id: User.first.id, vehicle_id: Vehicle.last.id, status: 'Pending')
Booking.create(start: date9, end: date10, user_id: User.first.id, vehicle_id: Vehicle.last.id, status: 'accepted')
Booking.create(start: date11, end: date12, user_id: User.first.id, vehicle_id: Vehicle.last.id, status: 'declined')
