...
User.create!(email: 'test1@test.com', encrypted_password: 'password', first_name: 'François', last_name: 'Parmentier', phone_number: '0000000000')
User.create!(email: 'test2@test.com', encrypted_password: 'password', first_name: 'Eric', last_name: 'Le Borgne', phone_number: '1111111111')
User.create!(email: 'test3@test.com', encrypted_password: 'password', first_name: 'Kevin', last_name: 'Tchiadeu', phone_number: '1111111111')
