...
Vehicle.create(user_id: User.first.id, name: 'Millenium Falcon', price: 1000, city: 'Kiev', category: 'SF', available: true, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbLFKaIBd1Hs6MZGm8_Y4YE7MyTOFrWlBZrQ&usqp=CAU')
Vehicle.create(user_id: User.first.id, name: 'DeLorean DMC-12', price: 220, city: 'Rennes', category: 'SF', available: true, image: 'https://www.motortrend.com/uploads/2022/03/1982_DeLorean_DMC-12_Time_Machine_Mecum_11.jpg')
Vehicle.create(user_id: User.first.id, name: 'the Flying Dutchman', price: 700, city: 'Saint-Domingue', category: 'Fantasy', available: true, image: 'https://i.pinimg.com/736x/23/4c/9f/234c9f872637c7d20d75a1294df2fa2c.jpg')
